...
const Navbar = () => {
  return (
    <div className="flex items-center justify-center h-[6rem] bg-[var(--main-color)] text-white">
        <div className="flex items-center justify-between  sm:w-[95rem]">
            <div>
            <Image src='/logo-vulcanica.png' alt='' width={120} height={20}/>
            </div>
            <div>
