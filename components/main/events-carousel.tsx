  ...
  return (
    <div className='embla flex flex-col w-full px-4 sm:px-0'>
          ...
          {events.map((event) => (
            <div className='embla__slide flex-[0_0_100%] min-w-0 flex-shrink-0 px-2 sm:px-0' key={event.id}>
              ...
              >
                ...
                <div className="flex flex-col sm:hidden w-full bg-white shadow-xl overflow-hidden rounded-2xl relative transition-all duration-300 hover:shadow-2xl">
                  ...
                  {event.image_url && (
                    <div className="relative w-full h-56 overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4 z-10">
                        <span className="px-3 py-1.5 bg-[var(--main-color)] text-white text-xs font-bold rounded-full shadow-lg backdrop-blur-sm">
                          {categoryLabels[event.category] || event.category}
                        </span>
                      </div>
                      <div className="absolute bottom-0 left-0 right-0 p-5 z-10">
                        <h3 className="text-white font-bold text-2xl leading-tight line-clamp-2 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)] mb-2">
                          {event.title}
                        </h3>
                        {event.price_info && (
                          <div className="flex items-center gap-2 mt-2">
                            <svg className="w-4 h-4 text-white drop-shadow-[0_1px_3px_rgba(0,0,0,0.8)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <span className="text-white text-sm font-semibold drop-shadow-[0_1px_3px_rgba(0,0,0,0.8)]">{event.price_info}</span>
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="p-5 flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-3 pt-2 border-t border-gray-100">
                      <div className="flex items-center gap-3 text-sm">
                        <div className="w-10 h-10 rounded-xl bg-[var(--main-color)]/10 flex items-center justify-center flex-shrink-0">
                      ...
                      <div className="flex items-center gap-3 text-sm">
                        ...
                        <div className="flex flex-col min-w-0">
                          <span className="font-bold text-gray-900 truncate">{event.location}</span>
                          {event.address && (
                            <span className="text-gray-600 text-xs mt-0.5 line-clamp-1">{event.address}</span>
                          )}
                        </div>
                      </div>
                    </div>
                    ...
                    {/* CTA Button */}
                    <div className="flex items-center justify-between mt-2 bg-gradient-to-r from-[var(--main-color)] to-[var(--main-color)]/90 text-white px-5 py-4 rounded-xl shadow-lg">
                      <span className="text-sm font-bold">Ver detalhes completos</span>
                ...
                <div className="hidden sm:flex flex-row gap-4 w-full aspect-[6/1.8] bg-white shadow-lg overflow-hidden rounded-xl relative">
                    ...
                    <div className="relative w-[50%] overflow-hidden group flex-shrink-0">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-3 z-10">
                        <div className="mb-1.5">
                          <span className="px-2.5 py-1 bg-[var(--main-color)] text-white text-xs font-semibold rounded-full shadow-lg">
                            {categoryLabels[event.category] || event.category}
                          </span>
                        </div>
                        <h3 className="text-white font-bold text-xl leading-tight line-clamp-2 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
                          {event.title}
                        </h3>
                      </div>
                    </div>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="max-w-[95vw] sm:max-w-6xl lg:max-w-7xl max-h-[90vh] overflow-y-auto p-0 bg-white border-0 shadow-2xl">
          {selectedEvent && (
            <>
